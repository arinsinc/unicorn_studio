...
public class StartupProgramSpecification implements Specification<StartupProgram> {
    private List<SearchCriteria> searchCriteriaList;

    public StartupProgramSpecification() {
    ...
    @Override
    public Predicate toPredicate(Root<StartupProgram> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
        ...
        for(SearchCriteria criteria : searchCriteriaList) {
            ...
            } else if (criteria.getKey().equals("name") || criteria.getKey().equals("profile")) {
